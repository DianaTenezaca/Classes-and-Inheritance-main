...
var destroyer = Fighter(name: "Destroyer", weapon: "Laser")
destroyer.moveRight()
...
// It doesn't work because falcon is a Spaceship instance, so it doesn't have access to Fighter functions/methods.
